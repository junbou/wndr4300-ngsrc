...
var bridge_items = [ "internet", "wireless", "guest","wan", "lan","qos", "parental","access_control","block_site", "block_services", "email", "schedule","wds","forwarding_triggering", "dns", "static", "remote", "upnp", "traffic", "ipv6"];
...
function click_adv_action(id)
{
		...
		{
			goto_formframe("USB_approved.htm");
