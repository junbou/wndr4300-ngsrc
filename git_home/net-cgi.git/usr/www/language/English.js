...
ready_share_info1="The ReadySHARE Cloud feature gives you remote access over the Internet to a USB storage device that is connected to your router's USB port."
how_setup_ready_share="How to Set Up ReadySHARE Cloud"
...
ready_share_step2="Step 2: On this page, enter your ReadySHARE Cloud user name and password to register your router and the USB device that is connected to it with your account."
...
ready_share_step4="Step 4: The first time, you are asked to download a Windows client, which is used to make a secure connection from your PC to the router's USB device. Log into this client and you can access the USB device from anywhere."
ready_share_set_note="<b>Note:</b> Without this client, you can browse your USB device contents but you cannot open files or make changes to them."
ready_share_start="Start now to enable ReadySHARE Cloud"
...
register="Register"
register_note="<b>Note:</b> Internet will be kept active until unregistered."
help_center="Help Center"
help_show_hide="Show/Hide Help Center"

resister_user="ReadySHARE Cloud is registered with user"
...
result_register_fail="Registration failed"
...
bh_check_ap="Checking your network setup, please wait..."
//BRS_00_02_ap_select.html
bh_ap_select_title="An existing router or gateway is detected in your network"
bh_ap_select_doc="Your NETGEAR router is connected to a network that already has another router. If you want to leave the first router connected, genie recommends using Access Point mode for the NETGEAR router. When the NETGEAR router is in Access Point mode, you can use it to join the network, and the other router continues to perform the same network tasks as before."
