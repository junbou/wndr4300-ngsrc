...
#define SNMP_TRAP_ACLFAIL		(7)
#define SNMP_TRAP_CONFCHANGE		(8)

#define SNMP_TRAP_ETHACLVIO		(9)
#define SNMP_TRAP_FWUPGRADEFAIL		(10)
#define SNMP_TRAP_CONFUPGRADEFAIL	(11)
#define SNMP_TRAP_INVALIDTEXTCONF	(12)
#define SNMP_TRAP_TIMEADOPTFAIL		(13)
#define SNMP_TRAP_RFTHRESHOLDTHRO	(14)
#define SNMP_TRAP_RFAVGRETRIES		(15)
#define SNMP_TRAP_PROCESSFAIL		(16)
