...
#if defined(CONFIG_WNR1000V2) || defined(CONFIG_WNR1100) || defined(CONFIG_WNR2200) || defined(CONFIG_WNR2000V3)
    ag7240_reg_wr(mac, AG7240_MAC_FIFO_CFG_5, 0x7ebcf);
#else
...
#ifndef SKIP_ATHEROS_ETHADDR_CHECKING
