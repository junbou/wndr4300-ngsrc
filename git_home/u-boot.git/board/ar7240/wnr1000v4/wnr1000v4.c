...
extern void enable_MDC_MDIO(void);
extern void ar9331_power_led_on(void);
extern void ar9331_power_led_off(void);
extern void ar9331_system_led_on(void);
extern void ar9331_system_led_off(void);
...
int checkboard (void)
{
    printf("WNR1000v4 (ar9330) U-boot dni29 V1.8\n");
    return 0;
}
