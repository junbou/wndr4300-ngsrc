...
/* GPIO pins */
#define POWER_LED_GPIO 		1	/* green */
#define SYSTEM_LED_GPIO 	27	/* amber */
...
void ar9331_power_led_on(void)
{
	...
	ar9331_gpio_out_val(POWER_LED_GPIO, LED_ON(POWER_LED_GPIO));
}

/*
 * Turn off green led
 */
void ar9331_power_led_off()
{
	ar9331_gpio_config_output(POWER_LED_GPIO);
	ar9331_gpio_out_val(POWER_LED_GPIO, LED_OFF(POWER_LED_GPIO));
}

/*
 * Turn amber led
 */
void ar9331_system_led_on(void)
{
	ar9331_gpio_config_output(SYSTEM_LED_GPIO);
	ar9331_gpio_out_val(SYSTEM_LED_GPIO, LED_ON(SYSTEM_LED_GPIO));
}

/*
 * Turn off amber led
 */
void ar9331_system_led_off(void)
{
	ar9331_gpio_config_output(SYSTEM_LED_GPIO);
	ar9331_gpio_out_val(SYSTEM_LED_GPIO, LED_OFF(SYSTEM_LED_GPIO));
}
