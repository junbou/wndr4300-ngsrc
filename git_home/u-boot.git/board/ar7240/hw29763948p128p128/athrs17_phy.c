...
void athrs17_reg_init()
{
    ...
    /* clear TX_BLINK_EN (bit 4) & RX_BLINK_EN (bit 5) to let LAN LEDs don't blink */
    athrs17_reg_write(S17_LED_CTRL0_REG,
                      (athrs17_reg_read(S17_LED_CTRL0_REG) & 0xFFFFFFCF));
    athrs17_reg_write(S17_LED_CTRL1_REG,
                      (athrs17_reg_read(S17_LED_CTRL1_REG) & 0xFFFFFFCF));
    athrs17_reg_write(S17_LED_CTRL2_REG,
                      (athrs17_reg_read(S17_LED_CTRL2_REG) & 0xFFFFFFCF));
    athrs17_reg_write(S17_LED_CTRL1_REG,
                      (athrs17_reg_read(S17_LED_CTRL1_REG) | 0x00000300));
    athrs17_reg_write(S17_LED_CTRL2_REG,
                      (athrs17_reg_read(S17_LED_CTRL1_REG) | 0x00000300));

    athr17_init_flag = 1;
    athrs17_reg_write(0x90, 0x0);
    printf("%s: complete\n",__func__);
}
