...
int checkboard (void)
{
    printf("WNR1000v2-VC (ar7240) U-boot dni29 V1.9\n");
    return 0;
}
#elif defined(CONFIG_WNR1000V2_VM)
int checkboard (void)
{
    printf("WNR1000v2-VM (ar7240) U-boot dni29 V1.9\n");
    return 0;
}
#else
int checkboard (void)
{
    printf("WNR1000v2 (ar7240) U-boot dni29 V2.0\n");
    return 0;
}
#endif
...
int wnr1000v2_reset_button_is_press()
{
...
int board_match_image_hw_id (ulong fw_image_addr)
{
    ...
    if (strcmp(image_model_id ,"WNR1000v2") == 0) {
        ...
        {
            printf("WNR1000v2 Firware, need check HW ID\n\n");
        }
    }
...
int board_match_image_model_id (ulong fw_image_addr)
{
    ...
    if (board_model_id[0] == 0xff || board_model_id[0] == 0x0) {
        printf("NODEL ID not set into board, ignore board model id check!\n");
        return 1;
    }
