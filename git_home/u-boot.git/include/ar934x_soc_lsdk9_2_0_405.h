...
#define DDR_PLL_CONFIG_NINT_VAL_25		DDR_PLL_CONFIG_NINT_SET(38)
#define DDR_PLL_CONFIG_NINT_VAL_40		DDR_PLL_CONFIG_NINT_SET(23)
#endif
#if defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64)
...
#if defined(CONFIG_WNDR3700V3)
#define DDR_PLL_NFRAC_40			DDR_PLL_DITHER_NFRAC_MIN_SET(767) | DDR_PLL_DITHER_NFRAC_MAX_SET(1023)
#endif
#if defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64)
...
#endif
#else
#error Only HW29763904P4P32 based on WASP Atheros AR934x can use this header file
#endif
#endif /* _AR934X_SOC_H */
