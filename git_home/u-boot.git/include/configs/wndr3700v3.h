...
#define CFG_STRING_TABLE_BASE_ADDR (CFG_IMAGE_ADDR_END)
#define CFG_STRING_TABLE_LEN 0x19000 /* Each string table takes 100K to save */
#define CFG_STRING_TABLE_NUMBER 5
#define CFG_STRING_TABLE_TOTAL_LEN 0x80000 /* Totally allocate 512K to save all string tables */
...
#define CFG_FLASH_CONFIG_BASE               (CFG_FLASH_BASE+0x7e0000)
...
#define CONFIG_BOOTCOMMAND	"md 0xb8040000 1;mw 0xb8040000 0x0003f31b 1;md 0xb8040000 1;bootm 0x9f050000"
 ...
 * It's HW_ID would be "29763948+8+128".
