...
#		define HW29763948P0P128P128P2X2P3X3_MTDPARTS_DEFAULT "mtdparts=ath-nand:128k(u-boot),384k(u-boot-env),1280k(uImage),7m(rootfs),128k(dummy),128k(caldata)"
#	else
#		define ATH_U_FILE	u-boot.bin
#		define ATH_U_CMD	nand_gen_cmd(lu, 0x0, 2fw.bin, 0x40000)
#		define HW29763948P0P128P128P2X2P3X3_MTDPARTS_DEFAULT "mtdparts=ath-nand:256k(u-boot),256k(u-boot-env),1280k(uImage),7m(rootfs),128k(dummy),128k(caldata)"
#	endif
...
#define	CONFIG_BOOTARGS		"console=ttyS0,115200 root=" ATH_ROOT_DEV " rootfstype=jffs2 init=/sbin/init " HW29763948P0P128P128P2X2P3X3_MTDPARTS_DEFAULT
...
/* HW_ID : 29763948+0+128+128+2x2+3x3 ,
 * PCB number + NOR size + Flash size + SDRam size + First Ratio + Second Ratio)
   MODEL_ID : wndr4300v1                                               */
