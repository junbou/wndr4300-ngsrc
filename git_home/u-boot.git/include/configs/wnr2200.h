...
#define CFG_STRING_TABLE_BASE_ADDR 0x9f6d0000
...
/*
 * As Netgear Tai's confrim, wnr2200 should no support BOARD_ID (HW_ID & MODEL_ID) detection at present.
 * I just add some Reserved item for that maybe used in the future, but we SHOULD NOT define macro
 * NETGEAR_BOARD_ID_SUPPORT at present unless get requirement from Tai.
 *
 * Hi Iceway,
 * It seems have side effect for adding MODEL_ID/HW_ID. So please do not add these on the new boot code.
 * Regards,
 * Tai
 */
...
/*
 * The different model use wnr2200 hardware.
 */
...
/*
 * for Predefine Wireless Secrity settings
 */
