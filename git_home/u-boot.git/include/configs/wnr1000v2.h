...
#define IH_MAGIC_DEFAULT       0x31303032
#else
...
/* WNR1000v2 hardware's PCB number is 29763331xx, 4M Flash, 32M SDRam
 * It's HW_ID would be "29763331+4+32".
...
#define BOARD_HW_ID_DEFAULT "29763331+4+32"

/*
 * The model use WNR1000v2 hardware.
 */
#define BOARD_MODEL_ID_OFFSET  ((BOARD_HW_ID_OFFSET) + (BOARD_HW_ID_LENGTH))
#define BOARD_MODEL_ID_LENGTH  10
#define BOARD_MODEL_ID_DEFAULT "WNR1000v2"
