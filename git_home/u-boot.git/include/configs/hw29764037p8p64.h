...
#define POWER_LED (1<<17)
#define TEST_LED (1<<14)
#define RESET_BUTTON_GPIO (1<<12)
...
#define CONFIG_BOOTCOMMAND	"md 0xb8040000 1;mw 0xb8040000 0x0003b31b 1;md 0xb8040000 1;bootm 0x9f050000"
...
/*
 * wndr3400v3 hardware's PCB number is 2976403701, 8M Flash, 64Ram
 * It's HW_ID would be "29764037+8+64".
