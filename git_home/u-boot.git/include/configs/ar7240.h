...
#if defined(CONFIG_AP121) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763847P16P64) || defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64) || defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763948P128P128) || defined(CONFIG_HW29763948P0P128P128P2X2P3X3)
#define	CFG_CBSIZE		512		/* Console I/O Buffer Size   */
#endif
#if defined(CONFIG_WNR1000V2) || defined(CONFIG_WNR1100) || defined(CONFIG_WNR2000V3) || defined(CONFIG_WNR2200)
...
#define CFG_PLL_333_333_166	0x00
...
#endif
#if defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64) || defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763948P128P128) || defined(CONFIG_HW29763948P0P128P128P2X2P3X3)
#define CFG_PLL_410_400_200	0x0a
#define CFG_PLL_420_400_200	0x0b
#define CFG_PLL_80_80_40	0x0c
#define CFG_PLL_64_64_32	0x0d
