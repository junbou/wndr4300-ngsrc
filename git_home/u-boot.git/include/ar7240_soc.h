...
#if defined(CONFIG_WASP_SUPPORT) && defined(CONFIG_WNDR3700V3)
#include <ar934x_soc_lsdk9_2_0_303.h>
#endif

#if defined(CONFIG_WASP_SUPPORT) && defined(CONFIG_HW29763904P4P32)
#include <ar934x_soc_lsdk9_2_0_405.h>
#endif

#if defined(CONFIG_WASP_SUPPORT) && defined(CONFIG_HW29764037P8P64)
#include <ar934x_soc_lsdk9_2_0_834.h>
#endif
...
#if defined(CONFIG_WASP) && (defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64))
...
#endif
#if defined(CONFIG_AP121) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763847P16P64)
...
#if defined(CONFIG_WASP) || defined(CONFIG_AP121) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763847P16P64)
...
#if defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64)
...
#endif
#if defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763904P4P32)
...
#elif defined(CONFIG_WNDR3700V3)
...
#elif defined(CONFIG_HW29763904P4P32)
...
#define CFG_934X_DDR2_EN_TWL_VAL	0xe59
#define CFG_934X_DDR2_TAP_VAL		0x10012
#elif defined(CONFIG_HW29764037P8P64)
#define CFG_934X_DDR2_CONFIG_VAL	0xc7d48cd0
#define CFG_934X_DDR2_MODE_VAL_INIT	0x133
...
#if defined(CONFIG_WASP_SUPPORT) && (defined(CONFIG_WNDR3700V3) || defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64))
#define is_wasp()	1
#else
#define is_wasp()	0
#endif
