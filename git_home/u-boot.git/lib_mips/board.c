...
uint32_t GetMagicNumberOfBoard(void)
{
	...
	return GetMagicNumberOfWnr1000v2();
#elif defined(CONFIG_WNR2200)
	return get_magic_number_of_wnr2200();
#elif defined(CONFIG_WNR2000V3)
	return get_magic_number_of_wnr2000v3();
#endif
}

#if defined(CONFIG_WNR1000V2)||defined(CONFIG_WNR1100)
/*return value 0:not pressed, 1:pressed*/
int reset_button_is_press()
{
#if defined(CONFIG_WNR1000V2)
...
#if defined(CONFIG_HW29763948P128P128) || defined(CONFIG_HW29763948P0P128P128P2X2P3X3)
...
#if defined(CONFIG_HW29763654P16P128) || defined(CONFIG_WNDR3700V1H2) || defined(CONFIG_HW29763847P16P64) || defined(CONFIG_HW29763904P4P32) || defined(CONFIG_HW29764037P8P64) || defined(CONFIG_WNDR3700V3) || defined(CONFIG_WNR1000V2) || defined(CONFIG_WNR1000V4) || defined(CONFIG_WNR1100) || defined(CONFIG_WNR2000V3) || defined(CONFIG_WNR2200)
...
Normal:
#endif
#if defined(CFG_NMRP) && !defined(CFG_CMD_NMRP)
		StartNmrpClient();
#endif
		main_loop ();
	}
