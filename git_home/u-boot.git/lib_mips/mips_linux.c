...
#ifdef CONFIG_AR7240
#if defined(CONFIG_WNR2200) || defined(CONFIG_WNR2000V3) || defined(CONFIG_AP121) || defined(CONFIG_WNR1000V4) || defined(CONFIG_HW29763847P16P64) || defined(CONFIG_HW29764037P8P64) || defined(CONFIG_WNDR3700V3)
