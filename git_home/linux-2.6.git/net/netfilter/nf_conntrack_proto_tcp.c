...
#if !defined(CONFIG_NF_CONNTRACK_POORMAN_TCP_WINDOW_CHECKING) && !defined(CONFIG_NF_CONNTRACK_POORMAN_TCP_WINDOW_CHECKING_MODULE)
#warning use tcp window checking of linux v2.6.x
...
#else
#include "nf_conntrack_poorman_proto_tcp.c"
#endif
