...
#if defined(CONFIG_NF_CONNTRACK_NAT_UDP_MANAGEMENT)
extern int dni_ct_hash_vmalloc;
extern struct hlist_nulls_head *dni_ct_hash;
extern u_int32_t dni_hash_conntrack(const struct nf_conntrack_tuple *tuple);
#endif

#if defined(CONFIG_NF_CONNTRACK_CONENAT_MANAGEMENT)
extern int conenat_ct_hash_vmalloc;
